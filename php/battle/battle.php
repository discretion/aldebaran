...
//          echo $other->getHP();
        ...
        echo "<br>".$Player1->getName()." as ".$Player1->getChar().", HP:".$Player1->getHP()." Power: ".$Player1->getPOW();
        //HP: ".$Player1->getHP()." Power: ";
        echo "<br>".$Player2->getName()." as ".$Player2->getChar().", HP:".$Player2->getHP()." Power: ".$Player2->getPOW();
